...
let { appId, projectName, needAria2 } = require('./common/projectInfo').default;
...
import codeShield from './common/main/codeShield';
import aria2Module from './common/main/aria2';
...
global.getWindow = function (name) {
	return global.windowObject[name];
};
if (!gotTheLock) {
	app.quit();
} else {
